insert into erp.userdata(iduser,username,password,rol) values(nextval('erp.userdata_id_seq'), '7gWwCJ9pQDeRdVjs1DQPaw==', '7gWwCJ9pQDeRdVjs1DQPaw==',
                                                             'USER');
insert into erp.userdata(iduser,username,password,rol) values(nextval('erp.userdata_id_seq'), 'aNoFcyQYjZNkqhh5dUErkA==', 'aNoFcyQYjZNkqhh5dUErkA==',
                                                             'ADMIN');
...
insert into erp.deactivate(iddeactivate, itemdeactivate, userdeactivate, reason, observation) values(nextval('erp.deactivate_id_seq'),1, 1,'UNPROVIDED','NO AVAILABLE');
...
insert into erp.itemdata_supplierdata(itemdata_id, supplierdata_id) values (1, 1);
insert into erp.itemdata_supplierdata(itemdata_id, supplierdata_id) values (2, 2);
